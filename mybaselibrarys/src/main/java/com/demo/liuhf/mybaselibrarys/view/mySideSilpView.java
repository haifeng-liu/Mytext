...
import com.demo.liuhf.mybaselibrarys.utils.DensityUtil;


/**
 * Created by liuhaifeng on 2018/3/7.
 */

public class mySideSilpView extends RelativeLayout {
    //侧滑方向-从哪侧滑出
    ...
    public mySideSilpView(Context context) {
        this(context, null);
    }
    public mySideSilpView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public mySideSilpView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 创建侧滑菜单View
     */
    public static mySideSilpView create(Activity activity) {
        mySideSilpView view = new mySideSilpView(activity);
        return view;
    }
    /**
     * 创建侧滑菜单View
     */
    public static mySideSilpView create(Activity activity, Positon positon) {
        mySideSilpView view = new mySideSilpView(activity);
    ...
    public void setMenuView(Activity activity, View view) {
        ...
        mMenuView.post(new Runnable() {
            ...
            public void run() {
                ...
                switch (mPositon) {
                    case LEFT:
                        mySideSilpView.this.scrollTo(mScreenWidth, 0);
                        break;
                    case RIGHT:
                        mySideSilpView.this.scrollTo(-mScreenWidth, 0);
                        break;
    ...
    public void dismiss() {
        ...
        switch (mPositon) {
            case LEFT:
                startScroll(mySideSilpView.this.getScrollX(), mMenuWidth, mDuration);
                break;
            case RIGHT:
                startScroll(mySideSilpView.this.getScrollX(), -mMenuWidth, mDuration);
                break;
